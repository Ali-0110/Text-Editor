...
def about():
    showinfo("About this program","This was programmed using python !")

def License():
    showinfo("License","HEY! Don't you trust me !")
...
text_area=Text(window,font=(font_name.get(),font_size.get()),bg="snow")
...
help_bar.add_command(label="View license",command=License)
